...
public class PersonalChatHandler : IRequestHandler<PersonalChatCommand, Result<PersonalChatDto>>
{
    private readonly IRepositoryWrapper _wrapper;
    private readonly IMapper _mapper;

    public PersonalChatHandler(IRepositoryWrapper wrapper, IMapper mapper)
    {
        _wrapper = wrapper;
        _mapper = mapper;
    }
    public async Task<Result<PersonalChatDto>> Handle(PersonalChatCommand request, CancellationToken cancellationToken)
    {
        var sharedСhat =
